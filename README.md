...
| 🌙 **Okos Sötét Mód** | Modern, szemkímélő sötét felület, amely nem rontja el a színeket és a képeket. |
| 🔄 **Végtelen Munkamenet** | Automatikusan frissíti a tokeneket, így nem dob ki a rendszer tétlenség miatt. |
| ⏰ **Szerver Óra** | Milliszekundum alapú szinkronizált óra a tűpontos tárgyfelvételhez. |
| 📶 **Ping Kijelzés** | Valós idejű válaszidő mérés, hogy lásd, mennyire terhelt a szerver. |
| 🚀 **Auto-Retry** | Ha a szerver "elhalálozik", a script automatikusan újrapróbálkozik. |

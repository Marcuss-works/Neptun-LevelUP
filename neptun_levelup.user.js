...
(function() {
    ...
    const THEMES = {
        ...
        red:     { main: '#e23d30', bg: '#000000', accent: '#FF0000' },
        rose:    { main: '#FF66B2', bg: '#000000', accent: '#ffff66' },
        levelup: { main: '#00dea4', bg: '#000000', accent: '#00fa9a' },
        violet:  { main: '#B266FF', bg: '#000000', accent: '#00ff00' },
        ocean:   { main: '#3399FF', bg: '#000000', accent: '#00ccff' },
        gold:    { main: '#ffcc00', bg: '#000000', accent: '#ffff66' },
    };
